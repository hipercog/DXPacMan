 ...
 */
void postDTPM( unsigned int look_AHead, int btLag, int alpha, int ID, char* path )
{
...
/**/
	...
	int i = 0, predir = -1, prdir2 = -1, compdir = -1, cmpdir2 = -1, temp, count, magnitude = 2;
