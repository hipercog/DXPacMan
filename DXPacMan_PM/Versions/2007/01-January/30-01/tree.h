...
// ----------------------------------------------------------------
template <class DataType>
bool Preorder( Tree<DataType>* p_node, short (*p_process)(Tree<DataType>*), int depth )
{
	int check_depth = 0;
