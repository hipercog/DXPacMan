...
double actions( int depth, int lookahead )
{
	...
	{
		PacState tempPS = S;
		if( S.dtpMap[xIndex][yIndex - 1] > 2 )
		{
			openDirs++;
			S.yPac--;
			if( S.dtpMap[xIndex][yIndex - 1] == 4 )
			{
				S.dtpMap[xIndex][yIndex - 1] = 6;
				S.Dots--;
				S.Points += 5;
			}else if( S.dtpMap[xIndex][yIndex - 1] == 5 )
			{
				S.dtpMap[xIndex][yIndex - 1] = 6;
				S.Pills--;
				S.Points += 50;
			...
			actArr[0] = Postorder( tree_GstMv, calculateState, depth - lookahead ) + actions( depth, lookahead-- );
			S = tempPS;
		}
		if( S.dtpMap[xIndex][yIndex + 1] > 2 )
		{
			...
			actArr[1] = Postorder( tree_GstMv, calculateState, depth - lookahead ) + actions( depth, lookahead-- );
			S = tempPS;
		}
		if( S.dtpMap[xIndex + 1][yIndex] > 2 )
		{
			openDirs++;
			S.xPac++;
			if( S.dtpMap[xIndex + 1][yIndex] == 4 )
			{
				S.dtpMap[xIndex + 1][yIndex] = 6;
				S.Dots--;
				S.Points += 5;
			}else if( S.dtpMap[xIndex + 1][yIndex] == 5 )
			{
				S.dtpMap[xIndex + 1][yIndex] = 6;
				S.Pills--;
				S.Points += 50;
			...
			actArr[2] = Postorder( tree_GstMv, calculateState, depth - lookahead ) + actions( depth, lookahead-- );
			S = tempPS;
		}
		if( S.dtpMap[xIndex - 1][yIndex] > 2 )
		{
			...
			actArr[3] = Postorder( tree_GstMv, calculateState, depth - lookahead ) + actions( depth, lookahead-- );
			S = tempPS;
		}
		int dir = highest( actArr, 4 );
