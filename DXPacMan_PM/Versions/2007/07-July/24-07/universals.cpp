...
/**/	news += "\n";
	...
	if(local)
	{
		...
		runclient("FileSend", file.c_str());	// 127.0.0.1	193.61.166.20	66.84.48.128
 ...
 *	Arguments : ip	-	IP addr for a remote machine - IP for my Jumpline host: 66.84.48.128
 ...
 */
void runclient(const char *cmd, const char *data)
{
	...
	{
		// Connect To Server
		w.connectServer("193.61.166.20", 27015);
...
/**/
	if(GameOver && strcmp(rec,"DataSend")==0){
