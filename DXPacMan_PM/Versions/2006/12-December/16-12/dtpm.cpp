...
char countSpawn(Tree<GhostMoves>* tree);
...
/**
 * Description: Will print out the contents of the global GhostMoves struct in 16x16 matrix form, 
 * with entries as either 0 or ghost[1-4].x.y
 */
void printGhostMoves()
{
...
/**
 * Legacy code, may be some useful ideas for functionality in future code.
 */
