...
/**/
	...
	A6_Chase¬Dots = Aggression6_Chase¬Dots( arg );					// 3	5	1 - 118		| 0.25 - 11.67	| 0.021 - 1	|
 ...
 */
	...
	result.push_back( A6_Chase¬Dots );
...
float ClassifyConqueror_Level( deque<PacState> arg )
{
	...
	if( ChryBool_Sum > 23 && A6_Chase¬Dots > 5 ){ conq -= 0.102941176; usage[11]++; usage[3]++; fired[17]--; }
	 ...
	 */
	if( C5_MvsWoutGain > 106 && P4b_HuntGst2_AvgSpd <= 1164 && P7_PutOffGstHse == 0 ){ conq -= 0.393491803; usage[8]++; usage[22]++; usage[23]++; fired[18]--; }

	if( S2a_LivesGained == 1 && S1c_AvgCycles <= 5650 && Lives_SDev <= 1.654 ){ conq += 0.327836066; usage[29]++; usage[28]++; usage[15]++; fired[19]++; }
/** /
	if( A4_HuntAfterPill <= 0.563 && S2a_LivesGained <= 0.627 && Lives_SDev <= 0.578 ){ conq -= 0.327737705; usage[2]++; usage[29]++; usage[15]++; fired[20]--; }

	if( S2a_LivesGained > 0.620 && C4_CaughtAfterHunt <= 0.557 && S1c_AvgCycles <= 0.680 ){ conq += 0.323647059; usage[29]++; usage[7]++; usage[28]++; fired[21]++; }

	if( C5_MvsWoutGain > 0.305 && C3_CloseCalls > 0.103 && C3_CloseCalls <= 0.206 ){ conq -= 0.311442623; usage[8]++; usage[6]++; usage[6]++; fired[22]--; }

	if( S1c_AvgCycles <= 0.458 && A4_HuntAfterPill > 0.181 && S2a_LivesGained > 0.429 ){ conq += 0.294117647; usage[28]++; usage[2]++; usage[29]++; fired[23]++; }

	if( C6_PntsOvrLives <= 0.506 && Lives_SDev <= 0.603 && S2a_LivesGained > 0.620 ){ conq += 0.279529412; usage[9]++; usage[15]++; usage[29]++; fired[24]++; }

	if( ChryBool_Sum > 0.137 && S2a_LivesGained > 0.620 && Lives_SDev <= 0.602 ){ conq += 0.2667; usage[11]++; usage[29]++; usage[15]++; fired[25]++; }

	if( Points_Max > 0.448 && P3_CntDtsB4Pll1 > 0.191 && P4a_HuntGst1_AvgSpd <= 0.676 ){ conq -= 0.220705882; usage[24]++; usage[20]++; usage[21]++; fired[26]--; }

	if( R2_AvgChrryPerLvl > 0.333 && P7_PutOffGstHse <= 0.438 && P7_PutOffGstHse > 0.292 ){ conq -= 0.219350147; usage[26]++; usage[23]++; usage[23]++; fired[27]--; }

	if( A4_HuntAfterPill <= 0.563 && R2_AvgChrryPerLvl <= 0.802 && A3_GhostKills > 0.378 ){ conq -= 0.213114754; usage[2]++; usage[26]++; usage[1]++; fired[28]--; }

	if( A4_HuntAfterPill > 0.173 && S5_GhostHunts > 0.941 && CycleCountPerState_SDev > 0.229 ){ conq -= 0.2; usage[2]++; usage[32]++; usage[12]++; fired[29]--; }

	if( A4_HuntAfterPill > 0.136 && S1b_AvgStates <= 0.639 && C6_PntsOvrLives <= 0.510 ){ conq += 0.176455882; usage[2]++; usage[27]++; usage[9]++; fired[30]++; }

	if( S1b_AvgStates <= 0.824 && C4_CaughtAfterHunt > 0.356 && S5_GhostHunts > 0.911 ){ conq -= 0.174110588; usage[27]++; usage[7]++; usage[32]++; fired[31]--; }

	if( R2_AvgChrryPerLvl > 0.333 && P7_PutOffGstHse > 0.438 && Lives_SDev <= 0.597 ){ conq += 0.163206441; usage[26]++; usage[23]++; usage[15]++; fired[32]++; }

	if( A4_HuntAfterPill <= 0.563 && S2a_LivesGained > 0.627 && Lives_SDev > 0.609 ){ conq -= 0.131163934; usage[2]++; usage[29]++; usage[15]++; fired[33]--; }

	if( ChryBool_Sum > 0.137 && C3_CloseCalls > 0.116 && A4_HuntAfterPill > 0.567 ){ conq += 0.119973333; usage[11]++; usage[6]++; usage[2]++; fired[34]++; }

	if( S2a_LivesGained <= 0.620 && A4_HuntAfterPill > 0.257 && A6_Chase¬Dots <= 0.124 ){ conq += 0.117647059; usage[29]++; usage[2]++; usage[3]++; fired[35]++; }
	 ...
	 * /
	if( A4_HuntAfterPill > 0.167 && S1b_AvgStates > 0.636 && C3_CloseCalls > 0.111 && S4_TeleportUse > 0.286 )
	{ conq -= 0.374970588; usage[2]++; usage[27]++; usage[6]++; usage[31]++; fired[36]--; }

	if( C5_MvsWoutGain > 0.413 && P7_PutOffGstHse <= 0.469 && C1b_ThreatPerception_NumKilled <= 0.417 && A4_HuntAfterPill <= 0.536 )
	{ conq -= 0.34442623; usage[8]++; usage[23]++; usage[4]++; usage[2]++; fired[37]--; }

	if( Lives_SDev <= 0.602 && A4_HuntAfterPill > 0.210 && CycleCountPerState_SDev <= 0.275 && C4_CaughtAfterHunt <= 0.360 )
	{ conq += 0.294264706; usage[15]++; usage[2]++; usage[12]++; usage[7]++; fired[38]++; }

	if( A4_HuntAfterPill > 0.173 && S5_GhostHunts <= 0.941 && A6_Chase¬Dots <= 0.454 && ChryBool_Sum > 0.144 )
	{ conq += 0.2933; usage[2]++; usage[32]++; usage[3]++; usage[11]++; fired[39]++; }

	if( C5_MvsWoutGain > 0.305 && ChryBool_Sum > 0.137 && R1_AvgTimeToEatChrry > 0.257 && A4_HuntAfterPill <= 0.456 )
	{ conq -= 0.278770492; usage[8]++; usage[11]++; usage[25]++; usage[2]++; fired[40]--; }

	if( R2_AvgChrryPerLvl > 0.333 && P7_PutOffGstHse <= 0.292 && C1b_ThreatPerception_NumKilled <= 0.167 && S2b_LivesLost <= 0.737 )
	{ conq -= 0.226133647; usage[26]++; usage[23]++; usage[4]++; usage[30]++; fired[41]--; }

	if( A4_HuntAfterPill <= 0.563 && R2_AvgChrryPerLvl <= 0.802 && A3_GhostKills <= 0.378 && P1c_GstsEtnOnPll <= 0.183 )
	{ conq -= 0.196688525; usage[2]++; usage[26]++; usage[1]++; usage[18]++; fired[42]--; }

	if( A4_HuntAfterPill > 0.167 && A1_AtkGstHse <= 0.134 && A6_Chase¬Dots <= 0.415 && P1c_GstsEtnOnPll > 0.139 )
	{ conq += 0.19175; usage[2]++; usage[0]++; usage[3]++; usage[18]++; fired[43]++; }

	if( A4_HuntAfterPill <= 0.563 && S2a_LivesGained > 0.627 && Lives_SDev <= 0.609 && P1_LureToPill > 0.031 )
	{ conq += 0.163934426; usage[2]++; usage[29]++; usage[15]++; usage[16]++; fired[44]++; }

	if( A4_HuntAfterPill <= 0.563 && S2a_LivesGained > 0.620 && D1_CyclesPerMove <= 0.368 && Lives_SDev <= 0.551 )
	{ conq += 0.161764706; usage[2]++; usage[29]++; usage[13]++; usage[15]++; fired[45]++; }

	if( R2_AvgChrryPerLvl > 0.333 && P7_PutOffGstHse <= 0.292 && C1b_ThreatPerception_NumKilled > 0.167 && S4_TeleportUse <= 0.641 )
	 ...
	 * /
	if( P1d_PacEtnB4GetPll <= 0 && C1b_ThreatPerception_NumKilled <= 0.333 && R2_AvgChrryPerLvl > 0.333 && P1c_GstsEtnOnPll <= 0.598 && P1b_2GstsLrd2Pll <= 0.167 && P4a_HuntGst1_AvgSpd <= 0.640 && R2_AvgChrryPerLvl <= 0.750 && A6_Chase¬Dots > 0.120 )
	{
		conq -= 0.161764706; 
		usage[19]++; usage[4]++; usage[26]++; usage[18]++; usage[17]++; usage[21]++; usage[26]++; usage[3]++; fired[47]--;
	}

	if( A4_HuntAfterPill > 0.167 && A1_AtkGstHse > 0.134 && P1d_PacEtnB4GetPll <= 0 && Lives_SDev <= 0.597 && C3_CloseCalls <= 0.359 && C7_KilledAtHouse <= 0.148 )
	{
		conq += 0.113455882;
		usage[2]++; usage[0]++; usage[19]++; usage[15]++; usage[6]++; usage[10]++; fired[48]++;
	}

	if( C5_MvsWoutGain <= 0.584 && A4_HuntAfterPill > 0.171 && C2b_AvgDstPacAtkCntrd <= 0.941 && C4_CaughtAfterHunt <= 0.554 && ChryBool_Sum > 0.136 )
	{
		conq += 0.4536;
...
rules.push_back( "if( A4_HuntAfterPill > 2 && C4_CaughtAfterHunt <= 2 )then Conqr\n" );
rules.push_back( "if( C5_MvsWoutGain <= 106 && S2a_LivesGained == 1 )then Conqr\n" );
rules.push_back( "if( A4_HuntAfterPill >= 1 && S1b_AvgStates <= 304 )then Conqr\n" );
rules.push_back( "if( A4_HuntAfterPill > 2 && S1c_AvgCycles <= 5650 )then Conqr\n" );
rules.push_back( "if( A4_HuntAfterPill > 1 && ChryBool_Sum <= 23 )then NotCq\n" );
rules.push_back( "if( Points_Max <= 1950 && P4b_HuntGst2_AvgSpd <= 38 )then Conqr\n" );
rules.push_back( "if( D2_Osclltng <= 123 && R1_AvgTimeToEatChrry <= 21 )then NotCq\n" );
rules.push_back( "if( ChryBool_Sum > 23 && C3_CloseCalls <= 2 )then Conqr\n" );
rules.push_back( "if( ChryBool_Sum > 23 && A6_Chase¬Dots > 5 )then NotCq\n" );
rules.push_back( "if( C5_MvsWoutGain > 106 && P4b_HuntGst2_AvgSpd <= 1164 && P7_PutOffGstHse == 0 )then NotCq\n" );
rules.push_back( "if( S2a_LivesGained == 1 && S1c_AvgCycles <= 5650 && Lives_SDev <= 1.654 )then Conqr\n" );
rules.push_back( "if( A4_HuntAfterPill <= 0.563 && S2a_LivesGained <= 0.627 && Lives_SDev <= 0.578 )then NotCq\n" );
rules.push_back( "if( S2a_LivesGained > 0.620 && C4_CaughtAfterHunt <= 0.557 && S1c_AvgCycles <= 0.680 )then Conqr\n" );
rules.push_back( "if( C5_MvsWoutGain > 0.305 && C3_CloseCalls > 0.103 && C3_CloseCalls <= 0.206 )then NotCq\n" );
rules.push_back( "if( S1c_AvgCycles <= 0.458 && A4_HuntAfterPill > 0.181 && S2a_LivesGained > 0.429 )then Conqr\n" );
rules.push_back( "if( C6_PntsOvrLives <= 0.506 && Lives_SDev <= 0.603 && S2a_LivesGained > 0.620 )then Conqr\n" );
rules.push_back( "if( ChryBool_Sum > 0.137 && S2a_LivesGained > 0.620 && Lives_SDev <= 0.602 )then Conqr\n" );
rules.push_back( "if( Points_Max > 0.448 && P3_CntDtsB4Pll1 > 0.191 && P4a_HuntGst1_AvgSpd <= 0.676 )then NotCq\n" );
rules.push_back( "if( R2_AvgChrryPerLvl > 0.333 && P7_PutOffGstHse <= 0.438 && P7_PutOffGstHse > 0.292 )then NotCq\n" );
rules.push_back( "if( A4_HuntAfterPill <= 0.563 && R2_AvgChrryPerLvl <= 0.802 && A3_GhostKills > 0.378 )then NotCq\n" );
rules.push_back( "if( A4_HuntAfterPill > 0.173 && S5_GhostHunts > 0.941 && CycleCountPerState_SDev > 0.229 )then NotCq\n" );
rules.push_back( "if( A4_HuntAfterPill > 0.136 && S1b_AvgStates <= 0.639 && C6_PntsOvrLives <= 0.510 )then Conqr\n" );
rules.push_back( "if( S1b_AvgStates <= 0.824 && C4_CaughtAfterHunt > 0.356 && S5_GhostHunts > 0.911 )then NotCq\n" );
rules.push_back( "if( R2_AvgChrryPerLvl > 0.333 && P7_PutOffGstHse > 0.438 && Lives_SDev <= 0.597 )then Conqr\n" );
rules.push_back( "if( A4_HuntAfterPill <= 0.563 && S2a_LivesGained > 0.627 && Lives_SDev > 0.609 )then NotCq\n" );
rules.push_back( "if( ChryBool_Sum > 0.137 && C3_CloseCalls > 0.116 && A4_HuntAfterPill > 0.567 )then Conqr\n" );
rules.push_back( "if( S2a_LivesGained <= 0.620 && A4_HuntAfterPill > 0.257 && A6_Chase¬Dots <= 0.124 )then Conqr\n" );
rules.push_back( "if( A4_HuntAfterPill > 0.167 && S1b_AvgStates > 0.636 && C3_CloseCalls > 0.111 && S4_TeleportUse > 0.286 )then NotCq\n" );
rules.push_back( "if( C5_MvsWoutGain > 0.413 && P7_PutOffGstHse <= 0.469 && C1b_ThreatPerception_NumKilled <= 0.417 && A4_HuntAfterPill <= 0.536 )then NotCq\n" );
rules.push_back( "if( Lives_SDev <= 0.602 && A4_HuntAfterPill > 0.210 && CycleCountPerState_SDev <= 0.275 && C4_CaughtAfterHunt <= 0.360 )then Conqr\n" );
rules.push_back( "if( A4_HuntAfterPill > 0.173 && S5_GhostHunts <= 0.941 && A6_Chase¬Dots <= 0.454 && ChryBool_Sum > 0.144 )then Conqr\n" );
rules.push_back( "if( C5_MvsWoutGain > 0.305 && ChryBool_Sum > 0.137 && R1_AvgTimeToEatChrry > 0.257 && A4_HuntAfterPill <= 0.456 )then NotCq\n" );
rules.push_back( "if( R2_AvgChrryPerLvl > 0.333 && P7_PutOffGstHse <= 0.292 && C1b_ThreatPerception_NumKilled <= 0.167 && S2b_LivesLost <= 0.737 )then NotCq\n" );
rules.push_back( "if( A4_HuntAfterPill <= 0.563 && R2_AvgChrryPerLvl <= 0.802 && A3_GhostKills <= 0.378 && P1c_GstsEtnOnPll <= 0.183 )then NotCq\n" );
rules.push_back( "if( A4_HuntAfterPill > 0.167 && A1_AtkGstHse <= 0.134 && A6_Chase¬Dots <= 0.415 && P1c_GstsEtnOnPll > 0.139 )then Conqr\n" );
rules.push_back( "if( A4_HuntAfterPill <= 0.563 && S2a_LivesGained > 0.627 && Lives_SDev <= 0.609 && P1_LureToPill > 0.031 )then Conqr\n" );
rules.push_back( "if( A4_HuntAfterPill <= 0.563 && S2a_LivesGained > 0.620 && D1_CyclesPerMove <= 0.368 && Lives_SDev <= 0.551 )then Conqr\n" );
rules.push_back( "if( R2_AvgChrryPerLvl > 0.333 && P7_PutOffGstHse <= 0.292 && C1b_ThreatPerception_NumKilled > 0.167 && S4_TeleportUse <= 0.641 )then Conqr\n" );
rules.push_back( "if( P1d_PacEtnB4GetPll <= 0 && C1b_ThreatPerception_NumKilled <= 0.333 && R2_AvgChrryPerLvl > 0.333 && P1c_GstsEtnOnPll <= 0.598 && P1b_2GstsLrd2Pll <= 0.167 && P4a_HuntGst1_AvgSpd <= 0.640 && R2_AvgChrryPerLvl <= 0.750 && A6_Chase¬Dots > 0.120 )then NotCq\n" );
rules.push_back( "if( A4_HuntAfterPill > 0.167 && A1_AtkGstHse > 0.134 && P1d_PacEtnB4GetPll <= 0 && Lives_SDev <= 0.597 && C3_CloseCalls <= 0.359 && C7_KilledAtHouse <= 0.148 )then Conqr\n" );
rules.push_back( "if( C5_MvsWoutGain <= 0.584 && A4_HuntAfterPill > 0.171 && C2b_AvgDstPacAtkCntrd <= 0.941 && C4_CaughtAfterHunt <= 0.554 && ChryBool_Sum > 0.136 ) then Conqr\n" );
