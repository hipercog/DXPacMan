...
/**/
	...
	float classification = ClassifyConqueror_Averages();
...
float ClassifyConqueror_Averages()
{
	...
	if( A4_HuntAfterPill[0] <= 1.16 ){ conq -= 0.213213115; usage[2]++; fired[2]--; }

	if( Points_Max[l-1] <= 1870 ){ conq += 0.161826824; usage[24]++; fired[3]++; }	// Can only fire on last level

	if( A4_HuntAfterPill[0] > 3.08 ){ conq += 0.147540984; usage[2]++; fired[4]++; }
	 ...
	 */
	if( A4_HuntAfterPill[0] > 2.5185 && C4_CaughtAfterHunt[0] <= 0.69625 ){ conq += 0.226733333; usage[2]++; usage[7]++; fired[9]++; }

	if( C5_MvsWoutGain[0] <= 106 && S2a_LivesGained[0] > 0.775 ){ conq += 0.213196721; usage[8]++; usage[29]++; fired[10]++; }

	if( A4_HuntAfterPill[0] >= 0.914 && S1b_AvgStates[0] <= 304 ){ conq += 0.191264706; usage[2]++; usage[27]++; fired[11]++; }

	if( A4_HuntAfterPill[0] > 3.08 && S1c_AvgCycles[0] <= 5653 ){ conq += 0.161764706; usage[2]++; usage[28]++; fired[12]++; }

	if( A4_HuntAfterPill[0] > 1.16 && ChryBool_Sum[0] <= 23 ){ conq -= 0.147540984; usage[2]++; usage[11]++; fired[13]--; }

	if( Points_Max[l-1] <= 1878 && P4b_HuntGst2_AvgSpd[0] <= 39 ){ conq += 0.132352941; usage[24]++; usage[22]++; fired[14]++; }	// Can only fire on last level
	...
	if( A4_HuntAfterPill[0] <= 3.08 && S2a_LivesGained[0] <= 0.78375 && Lives_SDev[0] <= 1.468 ){ conq -= 0.327737705; usage[2]++; usage[29]++; usage[15]++; fired[21]--; }
	...
	if( S1c_AvgCycles[0] <= 4396 && A4_HuntAfterPill[0] > 0.99 && S2a_LivesGained[0] > 0.53625 ){ conq += 0.294117647; usage[28]++; usage[2]++; usage[29]++; fired[23]++; }
	...
	if( Points_Max[l-1] > 1950 && P3_CntDtsB4Pll1[0] > 4 && P4a_HuntGst1_AvgSpd[0] <= 236 ){ conq -= 0.220705882; usage[24]++; usage[20]++; usage[21]++; fired[26]--; }
	...
	if( A4_HuntAfterPill[0] <= 3.08 && R2_AvgChrryPerLvl[0] <= 0.802 && A3_GhostKills[0] > 0.46 ){ conq -= 0.213114754; usage[2]++; usage[26]++; usage[1]++; fired[28]--; }
	...
	if( A4_HuntAfterPill[0] > 0.947175 && S5_GhostHunts[l] > 3.764 && CycleCountPerState_SDev[0] > 13 ){ conq -= 0.2; usage[2]++; usage[32]++; usage[12]++; fired[29]--; }

	if( A4_HuntAfterPill[0] > 0.7446 && S1b_AvgStates[0] <= 305 && C6_PntsOvrLives[0] <= 1912 ){ conq += 0.176455882; usage[2]++; usage[27]++; usage[9]++; fired[30]++; }
	...
	if( A4_HuntAfterPill[0] <= 3.08 && S2a_LivesGained[0] > 0.78375 && Lives_SDev[0] > 1.55 ){ conq -= 0.131163934; usage[2]++; usage[29]++; usage[15]++; fired[33]--; }

	if( ChryBool_Sum[0] > 23 && C3_CloseCalls[0] > 0.174 && A4_HuntAfterPill[0] > 3.104325 ){ conq += 0.119973333; usage[11]++; usage[6]++; usage[2]++; fired[34]++; }

	if( S2a_LivesGained[0] <= 0.775 && A4_HuntAfterPill[0] > 1.407075 && A6_Chase¬Dots[0] <= 1.447 ){ conq += 0.117647059; usage[29]++; usage[2]++; usage[3]++; fired[35]++; }
...
float ClassifyConqueror_Naive()
{
	 ...
	 *	0.106509836		Rule 3 Conqr (7.219; 0.9) if P7_PutOffGstHse_Avg > 0.656 then Conqr	// direct map - 0.375
	 */
	if( Lives_SDev[l] > 1.5 ){ conq -= 0.235264706; usage[15]++; fired[0]--; }	//weight[0] -= 0.01; }

	if( D2_Osclltng[l] > 122 ){ conq -= 0.2133; usage[14]++; fired[1]--; }

	if( A4_HuntAfterPill[l] <= 1 ){ conq -= 0.213213115; usage[2]++; fired[2]--; }

	if( Points_Max[l-1] <= 1895 ){ conq += 0.161826824; usage[24]++; fired[3]++; }
	...
	if( P7_PutOffGstHse[0] > 0.656 ){ conq += 0.106509836; usage[23]++; fired[8]++; }
	...
	if( C5_MvsWoutGain[l] <= 106 && S2a_LivesGained[0] > 0.620 ){ conq += 0.213196721; usage[8]++; usage[29]++; fired[10]++; }
	...
	if( Points_Max[l-1] <= 1950 && P4b_HuntGst2_AvgSpd[l] <= 38 ){ conq += 0.132352941; usage[24]++; usage[22]++; fired[14]++; }
	 ...
	 *	0.117647059	Rule 1 Conqr (10; 0.8) if S2.a_LivesGained_Avg <= 0.620 and HuntAfterPill_Avg > 0.257 and Chase¬Dots_Avg <= 0.124 then Conqr
	 */
	if( C5_MvsWoutGain[l] > 106 && P4b_HuntGst2_AvgSpd[l] <= 1164 && P7_PutOffGstHse[0] <= 0.469 ){ conq -= 0.393491803; usage[8]++; usage[22]++; usage[23]++; fired[19]--; }

	if( S2a_LivesGained[0] > 0.620 && S1c_AvgCycles[l] <= 5650 && Lives_SDev[l] <= 1.654 ){ conq += 0.327836066; usage[29]++; usage[28]++; usage[15]++; fired[20]++; }

	if( A4_HuntAfterPill[l] <= 2 && S2a_LivesGained[0] <= 0.627 && Lives_SDev[l] <= 1.469 ){ conq -= 0.327737705; usage[2]++; usage[29]++; usage[15]++; fired[21]--; }

	if( S2a_LivesGained[0] > 0.620 && C4_CaughtAfterHunt[l] <= 2 && S1c_AvgCycles[l] <= 6530 ){ conq += 0.323647059; usage[29]++; usage[7]++; usage[28]++; fired[22]++; }

	if( S1c_AvgCycles[l] <= 4410 && A4_HuntAfterPill[l] > 1 && S2a_LivesGained[0] > 0.429 ){ conq += 0.294117647; usage[28]++; usage[2]++; usage[29]++; fired[23]++; }

	if( C6_PntsOvrLives[l] <= 1900 && Lives_SDev[l] <= 1.54 && S2a_LivesGained[0] > 0.620 ){ conq += 0.279529412; usage[9]++; usage[15]++; usage[29]++; fired[24]++; }

	if( ChryBool_Sum[l] > 23 && S2a_LivesGained[0] > 0.620 && Lives_SDev[l] <= 1.54 ){ conq += 0.2667; usage[11]++; usage[29]++; usage[15]++; fired[25]++; }

	if( Points_Max[l-1] > 1950 && P3_CntDtsB4Pll1[l] > 19 && P4a_HuntGst1_AvgSpd[l] <= 230 ){ conq -= 0.220705882; usage[24]++; usage[20]++; usage[21]++; fired[26]--; }

	//This rule selects play where PutOffGstHse occurs between 1 sixth and 1 quarter times per level - can only be measured over 6 or more levels.
	if( R2_AvgChrryPerLvl[0] > 0.333 && P7_PutOffGstHse[0] <= 0.438 && P7_PutOffGstHse[0] >= 0.292 ){ conq -= 0.219350147; usage[26]++; usage[23]++; usage[23]++; fired[27]--; }

	if( A4_HuntAfterPill[l] <= 2 && R2_AvgChrryPerLvl[0] <= 0.802 && A3_GhostKills[l] > 0 ){ conq -= 0.213114754; usage[2]++; usage[26]++; usage[1]++; fired[28]--; }
	...
	if( R2_AvgChrryPerLvl[0] > 0.333 && P7_PutOffGstHse[0] > 0.438 && Lives_SDev[l] <= 1.52 ){ conq += 0.163206441; usage[26]++; usage[23]++; usage[15]++; fired[32]++; }

	if( A4_HuntAfterPill[l] <= 2 && S2a_LivesGained[0] > 0.627 && Lives_SDev[l] > 1.55 ){ conq -= 0.131163934; usage[2]++; usage[29]++; usage[15]++; fired[33]--; }

	if( ChryBool_Sum[l] > 23 && C3_CloseCalls[l] > 0 && A4_HuntAfterPill[l] > 2 ){ conq += 0.119973333; usage[11]++; usage[6]++; usage[2]++; fired[34]++; }

	if( S2a_LivesGained[0] <= 0.620 && A4_HuntAfterPill[l] > 1 && A6_Chase¬Dots[l] <= 1 ){ conq += 0.117647059; usage[29]++; usage[2]++; usage[3]++; fired[35]++; }
