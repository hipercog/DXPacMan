...
/**/
	...
	result.push_back( simple[1] );									// .03	2174 - 9598	|				| 0.226 - 1
	...
	result.push_back( resource[0] );								// .06	0 - 142		|				| 0 - 1
	...
	result.push_back( simple[0] );									// .14	220 - 478	|				| 0.459 - 1
	...
	result.push_back( resource[1] );								// .18	0 - 1		|				| 
	feature.push_back( "R2_AvgChrryPerLvl" );

	float a3 = Aggression3_GhostKills(arg); result.push_back( a3 );	// .19	0.021-1.217	|				| 0.017 - 1
	feature.push_back( "A3_GhostKills" );

	result.push_back( Caution3_CloseCalls( arg ) );					// .20	1 - 9		| 0.071 - 1.5	| 0.048 - 1
	feature.push_back( "C3_CloseCalls" );

	result.push_back(Planning5_SpeedOfHunt(arg)[2] / max(1,a3-4) );	// .21	0 - 2307	|				| 0 - 1
	feature.push_back( "HuntGst2_AvgSpd" );
