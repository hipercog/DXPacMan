 ...
 *	SUM THE SAVED DERIVED FEATURE SCORES FROM PREVIOUS LEVELS, ASSIGN TO deque[0] (except PointsMax - that total is in the raw data).
 */
void Record_Averages( int w, int lvl  )
{
...
/*	First rule to fire wins		*/
	...
	if( A4_HuntAfterPill[0] > 0.947175 && S5_GhostHunts[l] > 3.764 && CycleCountPerState_SDev[0] > 13 ){ conq -= 	0.2	; usage_Wdw[2]++; usage_Wdw[32]++; usage_Wdw[12]++; fired[23]--; }
	else
...
/*	First rule to fire wins		*/
	...
	if( C5_MvsWoutGain[0] > 106 && P4b_HuntGst2_AvgSpd[0] <= 1163 && P7_PutOffGstHse[0] <= 0.2678 ){ conq -= 	0.393491803	; usage_Avg[8]++; usage_Avg[22]++; usage_Avg[23]++; fired[1]--; }
	else
	if( A4_HuntAfterPill[0] > 0.914325 && S1b_AvgStates[0] > 304 && C3_CloseCalls[0] > 0.1665 && S4_TeleportUse[0] > 0.858 ){ conq -= 	0.374970588	; usage_Avg[2]++; usage_Avg[27]++; usage_Avg[6]++; usage_Avg[31]++; fired[2]--; }
	else
	if( C5_MvsWoutGain[0] > 106 && P7_PutOffGstHse[0] <= 0.2678 && C1b_ThreatPerception_NumKilled[0] <= 2.5 && A4_HuntAfterPill[0] <= 2.9346 ){ conq -= 	0.34442623	; usage_Avg[8]++; usage_Avg[23]++; usage_Avg[4]++; usage_Avg[2]++; fired[3]--; }
	else
	if( S2a_LivesGained[0] > 0.775 && S1c_AvgCycles[0] <= 5653 && Lives_SDev[0] <= 1.674 ){ conq += 	0.327836066	; usage_Avg[29]++; usage_Avg[28]++; usage_Avg[15]++; fired[4]++; }
	else
	if( A4_HuntAfterPill[0] <= 3.08 && S2a_LivesGained[0] <= 0.78375 && Lives_SDev[0] <= 1.468 ){ conq -= 	0.327737705	; usage_Avg[2]++; usage_Avg[29]++; usage_Avg[15]++; fired[5]--; }
	else
	if( S2a_LivesGained[0] > 0.775 && C4_CaughtAfterHunt[0] <= 0.69625 && S1c_AvgCycles[0] <= 6527 ){ conq += 	0.323647059	; usage_Avg[29]++; usage_Avg[7]++; usage_Avg[28]++; fired[6]++; }
	else
	if( C5_MvsWoutGain[0] > 78 && C3_CloseCalls[0] > 0.1545 ){ conq -= 	0.311442623	; usage_Avg[8]++; usage_Avg[6]++; usage_Avg[6]++; fired[7]--; }
	else
	if( Lives_SDev[0] <= 1.54 && A4_HuntAfterPill[0] > 1.14975 && CycleCountPerState_SDev[0] <= 15.7575 && C4_CaughtAfterHunt[0] <= 0.45 ){ conq += 	0.294264706	; usage_Avg[15]++; usage_Avg[2]++; usage_Avg[12]++; usage_Avg[7]++; fired[8]++; }
	else
	if( S1c_AvgCycles[0] <= 4396 && A4_HuntAfterPill[0] > 0.99 && S2a_LivesGained[0] > 0.53625 ){ conq += 	0.294117647	; usage_Avg[28]++; usage_Avg[2]++; usage_Avg[29]++; fired[9]++; }
	else
	...
	if( C6_PntsOvrLives[0] <= 1897 && Lives_SDev[0] <= 1.54 && S2a_LivesGained[0] > 0.775 ){ conq += 	0.279529412	; usage_Avg[9]++; usage_Avg[15]++; usage_Avg[29]++; fired[11]++; }
	else
	if( C5_MvsWoutGain[0] > 78 && ChryBool_Sum[0] > 23 && R1_AvgTimeToEatChrry[0] > 36 && A4_HuntAfterPill[0] <= 2.4966 ){ conq -= 	0.278770492	; usage_Avg[8]++; usage_Avg[11]++; usage_Avg[25]++; usage_Avg[2]++; fired[12]--; }
	else
	...
	if( Lives_SDev[0] > 1.5 ){ conq -= 	0.235264706	; usage_Avg[15]++; fired[14]--; }
	else
	if( A4_HuntAfterPill[0] > 2.5185 && C4_CaughtAfterHunt[0] <= 0.69625 ){ conq += 	0.226733333	; usage_Avg[2]++; usage_Avg[7]++; fired[15]++; }
	else
	if( R2_AvgChrryPerLvl[0] > 0.333 && P7_PutOffGstHse[0] <= 0.166732 && C1b_ThreatPerception_NumKilled[0] <= 1 && S2b_LivesLost[0] <= 0.737 ){ conq -= 	0.226133647	; usage_Avg[26]++; usage_Avg[23]++; usage_Avg[4]++; usage_Avg[30]++; fired[16]--; }
	else
	if( Points_Max[l-1] > 1950 && P3_CntDtsB4Pll1[0] > 4 && P4a_HuntGst1_AvgSpd[0] <= 236 ){ conq -= 	0.220705882	; usage_Avg[24]++; usage_Avg[20]++; usage_Avg[21]++; fired[17]--; }
	else
	if( R2_AvgChrryPerLvl[0] > 0.333 && P7_PutOffGstHse[0] <= 0.250098 && P7_PutOffGstHse[0] >= 0.166732 ){ conq -= 	0.219350147	; usage_Avg[26]++; usage_Avg[23]++; usage_Avg[23]++; fired[18]--; }
	else
	if( D2_Osclltng[0] > 122 ){ conq -= 	0.2133	; usage_Avg[14]++; fired[19]--; }
	else
	if( A4_HuntAfterPill[0] <= 1.16 ){ conq -= 	0.213213115	; usage_Avg[2]++; fired[20]--; }
	else
	if( C5_MvsWoutGain[0] <= 106 && S2a_LivesGained[0] > 0.775 ){ conq += 	0.213196721	; usage_Avg[8]++; usage_Avg[29]++; fired[21]++; }
	else
	if( A4_HuntAfterPill[0] <= 3.08 && R2_AvgChrryPerLvl[0] <= 0.802 && A3_GhostKills[0] > 0.46 ){ conq -= 	0.213114754	; usage_Avg[2]++; usage_Avg[26]++; usage_Avg[1]++; fired[22]--; }
	else
	if( A4_HuntAfterPill[0] > 0.947175 && S5_GhostHunts[l] > 3.764 && CycleCountPerState_SDev[0] > 13 ){ conq -= 	0.2	; usage_Avg[2]++; usage_Avg[32]++; usage_Avg[12]++; fired[23]--; }
	else
	if( A4_HuntAfterPill[0] <= 3.08 && R2_AvgChrryPerLvl[0] <= 0.802 && A3_GhostKills[0] <= 0.46 && P1c_GstsEtnOnPll[0] <= 0.6588 ){ conq -= 	0.196688525	; usage_Avg[2]++; usage_Avg[26]++; usage_Avg[1]++; usage_Avg[18]++; fired[24]--; }
	else
	...
	if( A4_HuntAfterPill[0] >= 0.914 && S1b_AvgStates[0] <= 304 ){ conq += 	0.191264706	; usage_Avg[2]++; usage_Avg[27]++; fired[26]++; }
	else
	if( A4_HuntAfterPill[0] > 0.7446 && S1b_AvgStates[0] <= 305 && C6_PntsOvrLives[0] <= 1912 ){ conq += 	0.176455882	; usage_Avg[2]++; usage_Avg[27]++; usage_Avg[9]++; fired[27]++; }
	else
	if( GameOver && S1b_AvgStates[0] <= 394 && C4_CaughtAfterHunt[0] > 0.445 && S5_GhostHunts[l] > 3.644 ){ conq -= 	0.174110588	; usage_Avg[27]++; usage_Avg[7]++; usage_Avg[32]++; fired[28]--; }
	else
	if( A4_HuntAfterPill[0] <= 3.08 && S2a_LivesGained[0] > 0.78375 && Lives_SDev[0] <= 1.55 && P1_LureToPill[0] > 0.08277 ){ conq += 	0.163934426	; usage_Avg[2]++; usage_Avg[29]++; usage_Avg[15]++; usage_Avg[16]++; fired[29]++; }
	else
	if( R2_AvgChrryPerLvl[0] > 0.333 && P7_PutOffGstHse[0] > 0.250098 && Lives_SDev[0] <= 1.52 ){ conq += 	0.163206441	; usage_Avg[26]++; usage_Avg[23]++; usage_Avg[15]++; fired[30]++; }
	else
	if( Points_Max[l-1] <= 1870 ){ conq += 	0.161826824	; usage_Avg[24]++; fired[31]++; }
	else
	if( A4_HuntAfterPill[0] > 3.08 && S1c_AvgCycles[0] <= 5653 ){ conq += 	0.161764706	; usage_Avg[2]++; usage_Avg[28]++; fired[32]++; }
	else
	if( A4_HuntAfterPill[0] <= 3.08 && S2a_LivesGained[0] > 0.775 && D1_CyclesPerMove[0] <= 15.6 && Lives_SDev[0] <= 1.4 ){ conq += 	0.161764706	; usage_Avg[2]++; usage_Avg[29]++; usage_Avg[13]++; usage_Avg[15]++; fired[33]++; }
	else
	if( P1d_PacEtnB4GetPll[0] <= 0 && C1b_ThreatPerception_NumKilled[0] <= 2 && R2_AvgChrryPerLvl[0] > 0.333 && P1c_GstsEtnOnPll[0] <= 2.1528 && P1b_2GstsLrd2Pll[0] <= 0.167 && P4a_HuntGst1_AvgSpd[0] <= 223 && R2_AvgChrryPerLvl[0] <= 0.750 && A6_Chase¬Dots[0] > 1.4 ){ conq -= 	0.161764706	; usage_Avg[19]++; usage_Avg[4]++; usage_Avg[26]++; usage_Avg[18]++; usage_Avg[17]++; usage_Avg[21]++; usage_Avg[26]++; usage_Avg[3]++; fired[34]--; }
	else
	if( A4_HuntAfterPill[0] > 3.08 ){ conq += 	0.147540984	; usage_Avg[2]++; fired[35]++; }
	else
	if( S1c_AvgCycles[0] > 5500 ){ conq -= 	0.147540984	; usage_Avg[28]++; fired[36]--; }
	else
	if( A4_HuntAfterPill[0] > 1.16 && ChryBool_Sum[0] <= 23 ){ conq -= 	0.147540984	; usage_Avg[2]++; usage_Avg[11]++; fired[37]--; }
	else
	if( ChryBool_Sum[0] <= 23 ){ conq -= 	0.1333	; usage_Avg[11]++; fired[38]--; }
	else
	if( Points_Max[l-1] <= 1878 && P4b_HuntGst2_AvgSpd[0] <= 39 ){ conq += 	0.132352941	; usage_Avg[24]++; usage_Avg[22]++; fired[39]++; }
	else
	if( R2_AvgChrryPerLvl[0] > 0.333 && P7_PutOffGstHse[0] <= 0.166732 && C1b_ThreatPerception_NumKilled[0] > 1 && S4_TeleportUse[0] <= 1.923 ){ conq += 	0.131411765	; usage_Avg[26]++; usage_Avg[23]++; usage_Avg[4]++; usage_Avg[31]++; fired[40]++; }
	else
	if( A4_HuntAfterPill[0] <= 3.08 && S2a_LivesGained[0] > 0.78375 && Lives_SDev[0] > 1.55 ){ conq -= 	0.131163934	; usage_Avg[2]++; usage_Avg[29]++; usage_Avg[15]++; fired[41]--; }
	else
	if( D2_Osclltng[0] <= 123 && R1_AvgTimeToEatChrry[0] <= 21 ){ conq -= 	0.126575738	; usage_Avg[14]++; usage_Avg[25]++; fired[42]--; }
	else
	if( ChryBool_Sum[0] > 23 && C3_CloseCalls[0] <= 0.174 ){ conq += 	0.12	; usage_Avg[11]++; usage_Avg[25]++; fired[43]++; }
	else
	if( ChryBool_Sum[0] > 23 && C3_CloseCalls[0] > 0.174 && A4_HuntAfterPill[0] > 3.104325 ){ conq += 	0.119973333	; usage_Avg[11]++; usage_Avg[6]++; usage_Avg[2]++; fired[44]++; }
	else
	if( S2a_LivesGained[0] <= 0.775 && A4_HuntAfterPill[0] > 1.407075 && A6_Chase¬Dots[0] <= 1.447 ){ conq += 	0.117647059	; usage_Avg[29]++; usage_Avg[2]++; usage_Avg[3]++; fired[45]++; }
	else
	if( A4_HuntAfterPill[0] > 0.914325 && A1_AtkGstHse[0] > 0.4288 && P1d_PacEtnB4GetPll[0] <= 0 && Lives_SDev[0] <= 1.52 && C3_CloseCalls[0] <= 0.5385 && C7_KilledAtHouse[0] <= 0.222 ){ conq += 	0.113455882	; usage_Avg[2]++; usage_Avg[0]++; usage_Avg[19]++; usage_Avg[15]++; usage_Avg[6]++; usage_Avg[10]++; fired[46]++; }
	else
	if( C5_MvsWoutGain[0] > 150 ){ conq -= 	0.1067	; usage_Avg[8]++; fired[47]--; }
	else
	if( P7_PutOffGstHse[0] > 0.375 ){ conq += 	0.106509836	; usage_Avg[23]++; fired[48]++; }
	else
	if( ChryBool_Sum[0] > 22 && A6_Chase¬Dots[0] > 5.25 ){ conq -= 	0.102941176	; usage_Avg[11]++; usage_Avg[3]++; fired[49]--; }
/**/
	return conq;
}
...
/*	First rule to fire wins		*/
	...
	if( C5_MvsWoutGain[l] > 106 && P4b_HuntGst2_AvgSpd[l] <= 1164 && P7_PutOffGstHse[l] == 0 ){ conq -= 	0.393491803	; usage_Nve[8]++; usage_Nve[22]++; usage_Nve[23]++; fired[1]--; }
	else
	...
	if( C5_MvsWoutGain[l] > 106 && P7_PutOffGstHse[l] == 0 && C1b_ThreatPerception_NumKilled[l] <= 2 && A4_HuntAfterPill[l] <= 2 ){ conq -= 	0.34442623	; usage_Nve[8]++; usage_Nve[23]++; usage_Nve[4]++; usage_Nve[2]++; fired[3]--; }
	else
	if( S2a_LivesGained[l] == 1 && S1c_AvgCycles[l] <= 5650 && Lives_SDev[l] <= 1.654 ){ conq += 	0.327836066	; usage_Nve[29]++; usage_Nve[28]++; usage_Nve[15]++; fired[4]++; }
	else
	if( A4_HuntAfterPill[l] <= 2 && S2a_LivesGained[l] == 0 && Lives_SDev[l] <= 1.469 ){ conq -= 	0.327737705	; usage_Nve[2]++; usage_Nve[29]++; usage_Nve[15]++; fired[5]--; }
	else
	if( S2a_LivesGained[l] == 1 && C4_CaughtAfterHunt[l] <= 2 && S1c_AvgCycles[l] <= 6530 ){ conq += 	0.323647059	; usage_Nve[29]++; usage_Nve[7]++; usage_Nve[28]++; fired[6]++; }
	else
	...
	if( S1c_AvgCycles[l] <= 4410 && A4_HuntAfterPill[l] > 1 && S2a_LivesGained[l] == 1 ){ conq += 	0.294117647	; usage_Nve[28]++; usage_Nve[2]++; usage_Nve[29]++; fired[9]++; }
	else
	if( A4_HuntAfterPill[l] > 1 && S5_GhostHunts[l] <= 3.75 && A6_Chase¬Dots[l] <= 5 && ChryBool_Sum[l] > 25 ){ conq += 	0.2933	; usage_Nve[2]++; usage_Nve[32]++; usage_Nve[3]++; usage_Nve[11]++; fired[10]++; }
	else
	if( C6_PntsOvrLives[l] <= 1900 && Lives_SDev[l] <= 1.54 && S2a_LivesGained[l] == 1 ){ conq += 	0.279529412	; usage_Nve[9]++; usage_Nve[15]++; usage_Nve[29]++; fired[11]++; }
	else
	...
	if( R2_AvgChrryPerLvl[l] == 1 && P7_PutOffGstHse[l] == 0 && C1b_ThreatPerception_NumKilled[l] <= 1 && S2b_LivesLost[l] <= 14 ){ conq -= 	0.226133647	; usage_Nve[26]++; usage_Nve[23]++; usage_Nve[4]++; usage_Nve[30]++; fired[16]--; }
	else
	...
	if( R2_AvgChrryPerLvl[l] == 1 && P7_PutOffGstHse[l] == 0 && P7_PutOffGstHse[l] == 1 ){ conq -= 	0.219350147	; usage_Nve[26]++; usage_Nve[23]++; usage_Nve[23]++; fired[18]--; }
	else
	if( D2_Osclltng[l] > 122 ){ conq -= 	0.2133	; usage_Nve[14]++; fired[19]--; }
	else
	if( A4_HuntAfterPill[l] <= 1 ){ conq -= 	0.213213115	; usage_Nve[2]++; fired[20]--; }
	else
	if( C5_MvsWoutGain[l] <= 106 && S2a_LivesGained[l] == 1 ){ conq += 	0.213196721	; usage_Nve[8]++; usage_Nve[29]++; fired[21]++; }
	else
	if( A4_HuntAfterPill[l] <= 2 && R2_AvgChrryPerLvl[l] == 0 && A3_GhostKills[l] > 0 ){ conq -= 	0.213114754	; usage_Nve[2]++; usage_Nve[26]++; usage_Nve[1]++; fired[22]--; }
	else
	...
	if( A4_HuntAfterPill[l] <= 2 && R2_AvgChrryPerLvl[l] == 1 && A3_GhostKills[l] <= 0 && P1c_GstsEtnOnPll[l] <= 1 ){ conq -= 	0.196688525	; usage_Nve[2]++; usage_Nve[26]++; usage_Nve[1]++; usage_Nve[18]++; fired[24]--; }
	else
	...
	if( S1b_AvgStates[l] <= 393 && C4_CaughtAfterHunt[l] > 2 && S5_GhostHunts[l] > 3.75 ){ conq -= 	0.174110588	; usage_Nve[27]++; usage_Nve[7]++; usage_Nve[32]++; fired[28]--; }
	else
	if( A4_HuntAfterPill[l] <= 2 && S2a_LivesGained[l] == 1 && Lives_SDev[l] <= 1.55 && P1_LureToPill[l] > 0 ){ conq += 	0.163934426	; usage_Nve[2]++; usage_Nve[29]++; usage_Nve[15]++; usage_Nve[16]++; fired[29]++; }
	else
	if( R2_AvgChrryPerLvl[l] == 1 && P7_PutOffGstHse[l] == 1 && Lives_SDev[l] <= 1.52 ){ conq += 	0.163206441	; usage_Nve[26]++; usage_Nve[23]++; usage_Nve[15]++; fired[30]++; }
	else
	...
	if( A4_HuntAfterPill[l] <= 2 && S2a_LivesGained[l] == 1 && D1_CyclesPerMove[l] <= 15.45 && Lives_SDev[l] <= 1.4 ){ conq += 	0.161764706	; usage_Nve[2]++; usage_Nve[29]++; usage_Nve[13]++; usage_Nve[15]++; fired[33]++; }
	else
	...
	if( R2_AvgChrryPerLvl[l] == 1 && P7_PutOffGstHse[l] == 0 && C1b_ThreatPerception_NumKilled[l] > 1 && S4_TeleportUse[l] <= 2 ){ conq += 	0.131411765	; usage_Nve[26]++; usage_Nve[23]++; usage_Nve[4]++; usage_Nve[31]++; fired[40]++; }
	else
	if( A4_HuntAfterPill[l] <= 2 && S2a_LivesGained[l] == 1 && Lives_SDev[l] > 1.55 ){ conq -= 	0.131163934	; usage_Nve[2]++; usage_Nve[29]++; usage_Nve[15]++; fired[41]--; }
	else
	...
	if( S2a_LivesGained[l] == 0 && A4_HuntAfterPill[l] > 1 && A6_Chase¬Dots[l] <= 1 ){ conq += 	0.117647059	; usage_Nve[29]++; usage_Nve[2]++; usage_Nve[3]++; fired[45]++; }
	else
	...
	if( P7_PutOffGstHse[l] == 1 ){ conq += 	0.106509836	; usage_Nve[23]++; fired[48]++; }
	else
...
float ClassifyConqueror_Naive( int lvl )
{
	...
	if( A4_HuntAfterPill[l] > 1 && S5_GhostHunts[l] > 3.75 && CycleCountPerState_SDev[l] > 13 ){ conq -= 0.2; usage_Nve[2]++; usage_Nve[32]++; usage_Nve[12]++; fired[29]--; }
