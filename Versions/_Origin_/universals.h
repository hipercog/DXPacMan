...
public:
	 ...
	 */
	PacState::PacState(int PacX, int PacY, int numLives, int numPoints, int numPills, int numDots, int moved, int cycle, int *ghostX, int *ghostY, bool cherryThere, bool pacAtk, int Map[20][20])
	{
		xPac = PacX;
		yPac = PacY;
		Lives = numLives;
