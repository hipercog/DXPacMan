...
// ----------------------------------------------------------------
template <class DataType>
void PreorderToDepth( Tree<DataType>* p_node, void (*p_process)(Tree<DataType>*), int depth )
{
	int check_depth = 0;
...
sprintf_s( out, 99, "%d", check_depth );
...
// ----------------------------------------------------------------
template <class DataType>
double PreorderAtDepth( Tree<DataType>* p_node, double (*p_process)(DataType*), int depth )
{
	double retval = 0.0;
	int check_depth = 0;
	...
	if( check_depth == depth )
		retval += p_process( p_node->m_data );
