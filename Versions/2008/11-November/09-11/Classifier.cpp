...
void Record_Averages( int w )
{
	int l = Level;
	res_Wdw.assign( 33, 0 );
	res_Wdw[1] = A1_AtkGstHse[0] = recAvgWindow( A1_AtkGstHse, w );
	res_Wdw[2] = A3_GhostKills[0] = recAvgWindow( A3_GhostKills, w );
	res_Wdw[3] = A4_HuntAfterPill[0] = recAvgWindow( A4_HuntAfterPill, w );
	res_Wdw[4] = A6_Chase¬Dots[0] = recAvgWindow( A6_Chase¬Dots, w );
	res_Wdw[5] = C1b_ThreatPerception_NumKilled[0] = recAvgWindow( C1b_ThreatPerception_NumKilled, w );
	res_Wdw[6] = C2b_AvgDstPacAtkCntrd[0] = recAvgWindow( C2b_AvgDstPacAtkCntrd, w );
	res_Wdw[7] = C3_CloseCalls[0] = recAvgWindow( C3_CloseCalls, w );
	res_Wdw[8] = C4_CaughtAfterHunt[0] = recAvgWindow( C4_CaughtAfterHunt, w );
	res_Wdw[9] = C5_MvsWoutGain[0] = recAvgWindow( C5_MvsWoutGain, w );
	res_Wdw[10] = C6_PntsOvrLives[0] = recAvgWindow( C6_PntsOvrLives, w );
	res_Wdw[11] = C7_KilledAtHouse[0] = recAvgWindow( C7_KilledAtHouse, w );
	res_Wdw[12] = ChryBool_Sum[0] = recAvgWindow( ChryBool_Sum, w );
	res_Wdw[13] = CycleCountPerState_SDev[0] = recAvgWindow( CycleCountPerState_SDev, w );
	res_Wdw[14] = D1_CyclesPerMove[0] = recAvgWindow( D1_CyclesPerMove, w );
	res_Wdw[15] = D2_Osclltng[0] = recAvgWindow( D2_Osclltng, w );
	res_Wdw[16] = Lives_SDev[0] = recAvgWindow( Lives_SDev, w );
	res_Wdw[17] = P1_LureToPill[0] = recAvgWindow( P1_LureToPill, w );
	res_Wdw[18] = P1b_2GstsLrd2Pll[0] = recAvgWindow( P1b_2GstsLrd2Pll, w );
	res_Wdw[19] = P1c_GstsEtnOnPll[0] = recAvgWindow( P1c_GstsEtnOnPll, w );
	res_Wdw[20] = P1d_PacEtnB4GetPll[0] = recAvgWindow( P1d_PacEtnB4GetPll, w );
	res_Wdw[21] = P3_CntDtsB4Pll1[0] = recAvgWindow( P3_CntDtsB4Pll1, w );
	res_Wdw[22] = P4a_HuntGst1_AvgSpd[0] = recAvgWindow( P4a_HuntGst1_AvgSpd, w );
	res_Wdw[23] = P4b_HuntGst2_AvgSpd[0] = recAvgWindow( P4b_HuntGst2_AvgSpd, w );
	res_Wdw[24] = P7_PutOffGstHse[0] = recAvgWindow( P7_PutOffGstHse, w );
	res_Wdw[25] = Points_Max[l-1];
	res_Wdw[26] = R1_AvgTimeToEatChrry[0] = recAvgWindow( R1_AvgTimeToEatChrry, w );
	res_Wdw[27] = R2_AvgChrryPerLvl[0] = recAvgWindow( R2_AvgChrryPerLvl, w );
	res_Wdw[28] = S1b_AvgStates[0] = recAvgWindow( S1b_AvgStates, w );
	res_Wdw[29] = S1c_AvgCycles[0] = recAvgWindow( S1c_AvgCycles, w );
	res_Wdw[30] = S2a_LivesGained[0] = recAvgWindow( S2a_LivesGained, w );
	res_Wdw[31] = S2b_LivesLost[0] = recAvgWindow( S2b_LivesLost, w );
	res_Wdw[32] = S4_TeleportUse[0] = recAvgWindow( S4_TeleportUse, w );
	res_Wdw[33] = S5_GhostHunts[0] = recAvgWindow( S5_GhostHunts, w );
}
