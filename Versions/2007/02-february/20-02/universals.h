...
public:
	...
	int xPac, yPac, Lives, Points, Pills, Dots;
	 ...
	 */
	PacState::PacState(int PacX, int PacY, int numLives, int numPoints, int numPills, int numDots, int *ghostX, int *ghostY, bool cherryEaten, bool PacAtk, int Map[20][20])
	{
		xPac = PacX;
		yPac = PacY;
		Lives = numLives;
