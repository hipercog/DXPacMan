...
/* This bit of code seems to have no effect - still best not to rule it out based on prelim testing. * /
...
/**/
		...
		matches += (float)match;
		sprintf_s( out, 99, "%f", matches / (float)(stateCount + real_State.State) );
